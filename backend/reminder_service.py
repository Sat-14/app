...
def send_voice_call_reminder(phone_number, message_body):
    ...
    # FIX: Use the correct header format with "Bearer"
    headers = {
        "authorization": f"Bearer {Config.BLAND_AI_API_KEY}"
    }
    
    # Payload for the voice call
    data = {
        "phone_number": phone_number,
        "task": message_body,  # Use the full message body for the task
        "voice": "stephanie"
    }
