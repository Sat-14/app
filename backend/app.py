...
from chatbot import chatbot_bp  # Import the new chatbot blueprint
...
# app.py
# (other imports)
from ai_service import AIService # <-- Make sure this line exists
...
def create_app():
    ...
    app.ai_service = AIService(app.config) # <-- ADD THIS LINE
    ...
    blueprints = [
        ...
        (loans_bp, '/api', 'loans'),
        (chatbot_bp, '/api', 'chatbot')  # Register the chatbot blueprint
    ]
...
if __name__ == '__main__':
    ...
    with app.app_context():
        try:
            # Import chatbot models to ensure they're registered
